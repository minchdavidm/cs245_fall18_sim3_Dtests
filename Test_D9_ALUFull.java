...
public class Test_D9_ALUFull
{
	public static void main(String[] args)
	{
		...
		aluUnit.aluOp[0].set(true);
		aluUnit.aluOp[1].set(true);
		aluUnit.aluOp[2].set(false);
		aluUnit.bNegate.set(true);

		aluUnit.a[0].set(true);
                aluUnit.a[1].set(false);
                aluUnit.a[2].set(true);
                aluUnit.a[3].set(true);
                aluUnit.a[4].set(true);
                aluUnit.a[5].set(false);
                aluUnit.a[6].set(true);
                aluUnit.a[7].set(false);

		aluUnit.b[0].set(true);
                aluUnit.b[1].set(true);
                aluUnit.b[2].set(false);
                aluUnit.b[3].set(true);
                aluUnit.b[4].set(true);
                aluUnit.b[5].set(true);
                aluUnit.b[6].set(false);
                aluUnit.b[7].set(true);
